...
namespace Cursach
{
    public partial class Prybil : Form
    {
        public Prybil()
        {
            InitializeComponent();
        ...
        private void Credit_Load(object sender, EventArgs e)
        {
            ...
            sqlconn.Open();
            SqlCommand Cmd = new SqlCommand("SELECT * FROM Prybil", sqlconn);
            ...
            reportViewer1.LocalReport.ReportEmbeddedResource = "Cursach.Report2.rdlc";
